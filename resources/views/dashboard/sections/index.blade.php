                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <label class="badge badge-success">{{
                                                                        trans('sections.Status_Section_AC') }}</label>
                                                                    @else
                                                                    <label class="badge badge-danger">{{
                                                                        trans('sections.Status_Section_No') }}</label>
                                                                    @endif
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button"
                                                                                ...
                                                                                data-dismiss="modal">{{
                                                                                trans('sections.Close') }}</button>
                                                                            <button type="submit"
                                                                                class="btn btn-danger">{{
                                                                                trans('sections.submit') }}</button>
                                                                        </div>
                                                                        </form>
                                                                    </div>
                                                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ route('sections.store') }}" method="POST">
                                    ...
                                    <div class="col">
                                        <label for="inputName" class="control-label">{{ trans('sections.Name_Grade')
                                            }}</label>
                                    ...
                                    <div class="col">
                                        <label for="inputName" class="control-label">{{ trans('sections.Name_Class')
                                            }}</label>
                                    ...
                                    <div class="col">
                                        <label for="inputName" class="control-label">{{ trans('Sections.Name_Teacher')
                                            }}</label>
